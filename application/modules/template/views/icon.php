	...
	<div class="container-fluid">
		...
		<section class="card">
			...
			<div class="card-block">
	      		...
	      		<form action="<?php echo base_url('template/icon') ?>" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<h5 class="m-t-lg with-border m-t-0">Icon</h5>
						...
						<div class="col-md-6">
					    	<label>Contoh Ukuran Icon:</label><br>
					        <img src="<?php echo base_url('dist/uploads/image/'.$site['icon']);?>">
					    </div>
