...
<head lang="en">
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>dist/admin/css/separate/pages/others.min.css">
	...
	<header class="site-header ">
	    <div class="container-fluid">
	        <a href="<?php echo base_url(); ?>" class="site-logo">
	            <img class="hidden-md-down" src="<?php echo base_url('dist/uploads/image/'.$site['logo']); ?>" alt="Pah Tsung">
	            <img class="hidden-lg-up" src="<?php echo base_url('dist/uploads/image/thumbs/'.$site['icon']); ?>" alt="">
	        </a>
	                ...
	                <div class="site-header-collapsed ">
	                    <div class="site-header-collapsed-in">
	                        ...
	                        <div class="dropdown dropdown-typical">
	                            ...
	                            <div class="dropdown-menu fontawesome-icon-list" aria-labelledby="dd-header-marketing">    
									
									<div class="dropdown-header">Sistem Config</div>
		                            <div class="dropdown-divider"></div>
		                            	<a class="dropdown-item" href="<?php echo base_url('template/general') ?>">
		                                	<i class="fa fa-globe"></i> General
		                                </a>	
		                                <a class="dropdown-item" href="<?php echo base_url('template/logo') ?>">
		                                	<i class="fa fa-globe"></i> Logo
		                                </a>
		                                <a class="dropdown-item" href="<?php echo base_url('template/icon') ?>">
		                                	<i class="fa fa-globe"></i> Icon
		                                </a>
		                            <div class="dropdown-divider"></div>	
		                            ...
		                            <div class="dropdown-divider"></div>	       
		                                ...
		                                <a class="dropdown-item" href="<?php echo base_url('user/role') ?>">
		                                	<i class="fa fa-user"></i> Role
		                                </a>
		                            <div class="dropdown-header">Menu</div>
		                            <div class="dropdown-divider"></div>	       
		                                <a class="dropdown-item" href="<?php echo base_url('user') ?>">
		                                	<i class="fa fa-user"></i> Data Menu
		                                </a>
