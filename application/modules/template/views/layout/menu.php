<nav class="side-menu jspScrollable">
    <ul class="side-menu-list">
        ...
        <li class="brown with-sub">
            ...
            <ul>
                <li class="with-sub"><a href="<?php echo base_url('sistem/entry'); ?>"> <span class="lbl"> Pengajuan</span></a></li>
                <li class="with-sub"><a href="<?php echo base_url('sistem/service'); ?>"><span class="lbl">Service / Maintance</span></a></li>
