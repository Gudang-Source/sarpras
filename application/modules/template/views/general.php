		...
		<div class="container-fluid">
			...
			<header class="section-header">
				<div class="tbl">
					...
					<ol class="breadcrumb breadcrumb-simple">
						<li><i fa class="fa fa-home"></i> <a href="<?php echo base_url('dashboard') ?>">Dashboard</a></li>
						<li><?php echo $menu ?></li>
					</ol>
				</div>
			</header>
	        ...
	        <?php echo form_open_multipart('template/general', array('class' => 'form-horizontal' , 'name' => 'form-signin_v1' ,'id' => 'form-signin_v1')); ?>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<h5 class="m-t-lg with-border m-t-0">General Config</h5>
									...
									<fieldset class="form-group">
										<label class="form-label"><i class="fa fa-phone"></i> No. Telp 1</label>
										<input name="no_telp"
											   type="text"
											   class="form-control"
									...
									<fieldset class="form-group">
										<label class="form-label"><i class="fa fa-phone"></i> No. Telp 2</label>
										<input name="no_telp2"
											   type="text"
											   class="form-control"
											   value="<?php echo $site['no_telp2'] ?>"
											   data-validation="[NOTEMPTY]">
									</fieldset>
							...
							<div class="col-lg-6">
								...
								<h5 class="m-t-lg with-border m-t-0">Keywords<small class="text-danger"><em>*</em></small></h5>
									<fieldset class="form-group">
										<textarea name="keywords" rows="2" class="form-control maxlength-simple" placeholder="<?php echo $site['keywords'] ?>" ><?php echo $site['keywords'] ?></textarea>
									</fieldset>	

								<h5 class="m-t-lg with-border m-t-0">Metatext<small class="text-danger"><em>*</em></small></h5>
									<fieldset class="form-group">
										<textarea name="metatext" rows="2" class="form-control maxlength-simple" placeholder="<?php echo $site['metatext'] ?>" ><?php echo $site['metatext'] ?></textarea>
									</fieldset>	

								<h5 class="m-t-lg with-border m-t-0">Google Maps<small class="text-danger"><em>*</em></small></h5>
									<fieldset class="form-group">
										<textarea name="maps" rows="2" class="form-control maxlength-simple" placeholder="<?php echo $site['maps'] ?>" ><?php echo $site['maps'] ?></textarea>
									</fieldset>

								<h5 class="m-t-lg with-border m-t-0">Footer Text<small class="text-danger"><em>*</em></small></h5>
									<fieldset class="form-group">
										<textarea name="footer_text" rows="2" class="form-control maxlength-simple" placeholder="<?php echo $site['footer_text'] ?>" value="" ><?php echo $site['footer_text'] ?></textarea>
									</fieldset>		
