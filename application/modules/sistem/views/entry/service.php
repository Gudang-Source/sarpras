          ...
          <section class="box-typical proj-page">
            ...
            <section class="proj-page-section">
              <form>
                ...
                <div class="form-group row">
                    <label class="col-sm-2 form-control-label">Pilih Unit</label>
                    <div class="col-md-6 col-sm-6">
                        <div class="checkbox-detailed">
                            ...
                            <span class="checkbox-detailed-tbl">
                              <span class="checkbox-detailed-cell">
                                <span class="checkbox-detailed-title">Unit Sarpras</span>
                                <small>Untuk Barang dan </small>
                              </span>
                            </span>
                            </label>
                        </div>
                        <div class="checkbox-detailed">
                            ...
                            <span class="checkbox-detailed-tbl">
                              <span class="checkbox-detailed-cell">
                                <span class="checkbox-detailed-title">Unit IT</span>
                                <small>Service Barang IT</small>
                              </span>
                            </span>
                            </label>
                        </div>
