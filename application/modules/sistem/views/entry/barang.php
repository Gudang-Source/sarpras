...
<!--.page-content-header-->
     ...
     <?php if($this->session->flashdata('error')){echo '<strong class="text-danger">'.$this->session->flashdata('error').'</strong>';}?>
         ...
         <?php echo form_open_multipart('sistem/entry/barang', array('class' => 'form-horizontal' , 'name' => 'add_name' ,'id' => 'add_name')); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
              <fieldset class="form-group">
                ...
                <input readonly="" name="nama" type="text" class="form-control" value="<?php echo $this->session->userdata('username') ?>" >
              </fieldset>
            </div>
            <div class="col-lg-4 col-md-4">
              <fieldset class="form-group">
