            ...
            <tr>
              ...
              <td width="30%" align="center">
                ...
                <?php if ($dataPo->status_po == ''  ){ ?>
                  ...
                  <!-- <a href="<?php echo base_url('proses/print-po-barang/'.$dataPo->id_po);?>" class="btn btn-inline btn-info btn-sm ladda-button" onclick="window.open(this.href, 'mywin','left=10,top=20,toolbar=0,resizable=0'); return false;"><i class="fa fa-print"></i> Print</a> -->
                  <a href="<?php echo base_url('proses/print-po-barang/'.$dataPo->id_po);?>" class="btn btn-inline btn-info btn-sm ladda-button"  target="_blank"><i class="fa fa-print"></i> Print</a>

                  <a href="<?php echo base_url('proses/terima-barang/'.$dataPo->id_po);?>" class="btn btn-inline btn-success btn-sm ladda-button" ><i class="font-icon font-icon-notebook-bird"></i> Terima</a>

                  <a href="<?php echo base_url('proses/pembelian-batal-po/'.$dataPo->id_po);?>" class="btn btn-inline btn-danger btn-sm ladda-button" ><i class="fa fa-trash"></i> Batal</a>
                 ...
                 <!--  <button type="button" class="btn btn-inline btn-danger btn-sm ladda-button" data-toggle="modal" data-target="#myModalBatal<?php echo $dataPo->id_po;?>">Batal</button> -->

                   <!-- Modal -->
                    <div class="modal fade" id="myModalBatal<?php echo $dataPo->id_po;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="<?php echo base_url('backend/laporan/barang/dibatalkan/'.$dataPo->id_po);?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Batal"><i class="fa fa-close"></i> Batal</a>
                          </div>
                        </div>
                      </div>
                    </div>
