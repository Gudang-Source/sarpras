  ...
  <header class="page-content-header">
      <div class="container-fluid">
        <div class="tbl">
          <div class="tbl-row">
            <div class="tbl-cell">
              <h2>Permintaan ATK Edit</h2>
              <div class="subtitle">Proses / PermintaanATK Edit</div>
            </div>
  ...
  <section class="card" style="padding: 35px;">
    <div class="card-block">
      ...
      <?php echo form_open('proses/unit-edit-atk/'.$barang->id_order_atk, array('class' => 'row')); ?> 
        <!-- info row -->
        ...
        <div class="row invoice-info">
          ...
          <div class="col-sm-4  invoice-col">
            ...
            <address>
              ...
              <input class="form-control" name="subjek" type="text" value="<?php echo $barang->subjek; ?>"><br>
