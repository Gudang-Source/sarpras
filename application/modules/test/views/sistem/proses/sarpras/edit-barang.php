  ...
  <section class="card" style="padding: 35px;">
    ...
    <?php echo form_open('proses/sarpras-edit-barang/'.$barang->id_order_barang, array('class' => 'row')); ?> 
      <!-- info row -->
              ...
              <?php $no=0; foreach ($barangitem as $dataBarang) { $no++; ?>
                ...
                <tr>
                  ...
                  <td align="center" width="10%">
                    <input type="text" name="jumlah_sarpras[]" class="form-control" value="<?php echo $dataBarang->jumlah; ?>">
      ...
      <div class="row">
        <div class="col-xs-6">
         ...
         <p class="text-muted" align="justify">
           <textarea name="keterangan_sarpras"  cols="60" rows="8" class="form-control"></textarea>
          </p>
