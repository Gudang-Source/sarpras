          ...
          <?php foreach ($barang as $dataBarang) {
            ...
            <tr>
              ...
              <td>
                ...
                <!-- Menu User -->
                <?php if ( $dataBarang->status_sarpras == 'Proses') { ?>
                  <!-- Edit -->
                  <a href="<?php echo base_url('proses/sarpras-edit-barang/'.$dataBarang->id_order_barang);?>" class="btn btn-inline btn-success btn-sm ladda-button" data-toggle="tooltip" data-placement="top" ><i class="fa fa-cash"></i> Proses</a>
