      ...
      <div class="card-block">
        <table id="tablePengajuanAtk" class="display table table-bordered" cellspacing="0" width="100%">
          ...
          <?php foreach ($barang as $dataBarang) {  
           if ($dataBarang->divisi == 'PEMBELIAN' ) { ?>
            ...
            <tr>
              ...
              <?php if ($dataBarang->status == 'Kepsek') { ?>
                ...
                <a href="<?php echo base_url('proses/sarpras-edit-atk/'.$dataBarang->id_order_atk);?>" class="btn btn-inline btn-success btn-sm ladda-button" data-toggle="tooltip" data-placement="top" ><i class="fa fa-credit-card"></i> Proses</a>
              <?php } else { ?>
