        ...
        <div class="card-block">
          <table id="tablePengajuanAtk" class="display table table-bordered" cellspacing="0" width="100%">
            ...
            <?php foreach ($barang as $dataBarang) {  ?>
              <tr>
                <td width="8%"><?php echo $dataBarang->no_order_atk;?></td>
                <td><?php echo $dataBarang->nama;?></td>
                <td><?php echo $dataBarang->divisi;?></td>
                ...
                <?php if ($dataBarang->status_unit == 'Proses') { ?>
                  ...
                  <a href="<?php echo base_url('backend/proses/permintaan_atk/userAtkE/'.$dataBarang->id_order_atk);?>" class="btn btn-inline btn-warning btn-sm ladda-button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                   <!-- Batal -->
                      <button type="button" class="btn btn-inline btn-danger btn-sm ladda-button" data-toggle="modal" data-target="#myModalBatal<?php echo $dataBarang->id_order_atk ?>">Batal</button>
                ...
                <?php } ?>
                  <a href="<?php echo base_url('backend/proses/permintaan_atk/atkprint/'.$dataBarang->id_order_atk);?>" class="btn btn-inline btn-info btn-sm ladda-button" target="_blank" data-toggle="tooltip" data-placement="top" title="Print"><i class="fa fa-print"></i></a>

                  <a href="<?php echo base_url('backend/proses/permintaan_atk/userAtkV/'.$dataBarang->id_order_atk);?>" class="btn btn-inline btn-primary btn-sm ladda-button" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a>
