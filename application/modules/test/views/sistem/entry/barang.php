<!-- <div class="page-content"> -->
  <header class="page-content-header">
        ...
        <div class="tbl">
          <div class="tbl-row">
            <div class="tbl-cell">
              ...
              <div class="subtitle">Entry / Pengajuan Barang </div>
            </div>
     ...
     <?php if($this->session->flashdata('error')){echo '<strong class="text-danger">'.$this->session->flashdata('error').'</strong>';}?>
         ...
         <?php echo form_open_multipart('entry/proses-barang', array('class' => 'form-horizontal' , 'name' => 'add_name' ,'id' => 'add_name')); ?>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
              <fieldset class="form-group">
                ...
                <input name="nama" type="text" class="form-control" value="<?php echo $user->username ?>" >
                <input name="id_user" type="text" class="form-control"  value="<?php echo $user->id_admin ?>" hidden>
            ...
            <div class="col-lg-4 col-md-4">
              <fieldset class="form-group">
                ...
                <input name="nik" type="text" class="form-control" value="<?php echo $user->nik ?>" readonly="">
            ...
            <div class="col-lg-4 col-md-4">
              <fieldset class="form-group">
                ...
                <input name="divisi" type="text" class="form-control" value="<?php echo $user->divisi ?>" readonly="">
              </fieldset>
            </div>
              ...
              <fieldset class="form-group">
                <label class="form-label" for="exampleInputDisabled">File Upload</label>
                  ...
                  <small class="text-danger">
                    <em>Allowed file is PNG, JPG, DOC &amp; PDF / Max File 1 mb</em>
                  </small>           
              </fieldset>
            </div>  
