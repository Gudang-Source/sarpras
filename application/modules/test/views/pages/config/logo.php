...
<div class="container-fluid">
			...
			<section class="card">
		      ...
		      <form action="<?php echo base_url('admin/pages/config/logo') ?>" method="post" enctype="multipart/form-data">
						...
						<div class="row">
					        ...
					        <img src="<?php echo base_url('dist/upload/image/thumbs/'.$site['logo']);?>">
					    </div>
