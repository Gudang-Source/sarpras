			...
			<table>
				<body >
					<tr>
						...
						<td style="width:60%;"> <b><?php echo $detail_barang->id_barang_group; ?>.<?php echo $detail_barang->id_barang_subgroup; ?>.<?php echo $detail_barang->no_barang; ?>.<?php echo $detail_barang->no_tahun; ?>.<?php echo $detail_barang->no_bulan; ?>.<?php echo $detail_barang->no_item; ?> </b></td>
					</tr>	
					<tr>
			 ...
			 <img src="<?php echo base_url() ?>test/pages/barang/barcode/<?php echo $detail_barang->id_barang_group; ?>.<?php echo $detail_barang->id_barang_subgroup; ?>.<?php echo $detail_barang->no_barang; ?>.<?php echo $detail_barang->no_tahun; ?>.<?php echo $detail_barang->no_bulan; ?>.<?php echo $detail_barang->no_item; ?>" >
			 <br><br><br>
		</div>
</div>
</body>
