...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        cartItemTemplate: '<img class="img-responsive pull-left" src="{product_image}" /><h4 class="list-group-item-heading">{product_name}</h4></p><p class="list-group-item-text">{product_idorder}</p><p class="list-group-item-text">{product_desc}</p>',
        ...
        lang: { // Language variables
            cartTitle: "List Barang PO",
            checkout: 'Buat PO',
            clear: 'Clear',
            subtotal: 'Jumlah:',
            cartRemove: '×',
            cartEmpty: 'List Barang PO kosong !!<br /> Pilih Barang'
        },
        submitSettings: {
    ...
    $.extend(SmartCart.prototype, {
        ...
        _addUpdateCartItem: function (p) {
            ...
            if (elmMain && elmMain.length > 0) {
                ...
                var itemSummary = '<div class="sc-cart-item-summary"><span class="sc-cart-item-price">' + (p[this.options.paramSettings.productPrice]) + '</span>';
